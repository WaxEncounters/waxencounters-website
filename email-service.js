...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="https://yourusername.github.io/vinyl-main/account.html" class="button">Access Your Account</a>
...
<body>
    ...
    generateVerificationLink(userEmail, token) {
        ...
        if (window.location.protocol === 'file:') {
            ...
            const githubUsername = 'WaxEncounters'; // You need to update this
            const baseUrl = `https://${githubUsername}.github.io/vinyl-main`;
